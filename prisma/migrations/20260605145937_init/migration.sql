...
-- CreateEnum
CREATE TYPE "PrescriptionStatus" AS ENUM ('PENDING', 'PROCESSED', 'COMPLETED', 'CANCELLED');
...
-- AddForeignKey
ALTER TABLE "Prescription" ADD CONSTRAINT "Prescription_processedById_fkey" FOREIGN KEY ("processedById") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
